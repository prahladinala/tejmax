    ...
    const myTheatreForm = () => (
        <form>
            <div className="form-group">
                ...
                <input onChange={handleChange} value={name} type="text" className="form-control my-3" autoFocus required placeholder="For Ex. Marvel Theatre" />
                <button onClick={onSubmit} className="btn btn-outline-info">Add theatre</button>
            </div>
        </form>
    )
